...
import { 
  ...
  Server, LayoutGrid, List, BrainCircuit, Clock, AlertTrianglimport React, { useState, useEffect, useContext, createContext } from 'react';
import { 
  AreaChart, Area, XAxis, YAxis, CartesianGrid, Tooltip as RechartsTooltip, Legend, ResponsiveContainer 
} from 'recharts';
import { 
...
const DataProvider = ({ children, user }) => {
  ...
  const api = {
    ...
    deleteUser: async (uid) => {
      // Deletes the user profile document (Note: does not delete Firebase Auth user, requires backend for that)
      try {
